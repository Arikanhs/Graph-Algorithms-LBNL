...
int main(int argc, char* argv[])
{
    ...
    **/
    ...
    Kokkos::parallel_reduce("Outer Reduction", team_policy(vertices -1, Kokkos::AUTO), KOKKOS_LAMBDA ( const member_type& team, int &outer_reduction) {
	...
	//int iterationIndexes = limit - i;
    	...
    	Kokkos::parallel_reduce(Kokkos::TeamThreadRange(team, i, limit), [=] (int b, int& inner_reduction){
