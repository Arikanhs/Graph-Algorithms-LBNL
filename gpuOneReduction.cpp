...
int main(int argc, char* argv[])
{
    ...
    // Converting 2D array to CSR structure
    ...
    // Assuming the Csr is not empty
    Kokkos::parallel_reduce("Csr loop", range_policy(0, vertices -1), KOKKOS_LAMBDA(int a, int& reduction){
    //for(int a = 0; a < indexPointer.size() -1 ; a++){
