...
int main(int argc, char* argv[]) {
    ...
    **/
	...
	Kokkos::deep_copy( change, h_change );
        ...
        Kokkos::parallel_for("first loop", team_policy(vertices, 1024), KOKKOS_LAMBDA(const member_type& team){
	    ...
	    Kokkos::parallel_for(Kokkos::TeamThreadRange(team, v, limit), [=] (int v2){
            //for (; v < limit; v++) {

                int v_element = indicesView(v2);
